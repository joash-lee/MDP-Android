...
public class Constant {
	...
	public static final int BOARDWIDTH = 40; // By default, this should be 20. This must be greater than 3 as the Robot assumes to take 3x3 grid.
	public static final int BOARDHEIGHT = 40; // By default, this should be 15. This must be greater than 3 as the Robot assumes to take 3x3 grid.
	public static final int STARTPOINTHEIGHT = 5;
	public static final int STARTPOINTWIDTH = 5;
	public static final int ENDPOINTHEIGHT = 5;
	public static final int ENDPOINTWIDTH = 5;
	...
	public static final int[] END = {37,37};
	...
	public static final int ROBOTHEIGHT = 40; // By default, this should be twice of the grid height. GRIDHEIGHT * 2
	public static final int ROBOTWIDTH = 40; // By default, this should be twice of the grid width. GRIDWIDTH * 2
